...
### 1. Funnel-Shaped Road Network

The community contains many local residential roads that ultimately converge onto a small number of internal connectors and regional mountain corridors.

This creates a **funnel effect**, where many vehicles must pass through a few narrow segments.

### 2. Internal Choke Points Likely Control Evacuation Performance

Several road segments appear to collect traffic from multiple neighborhoods before vehicles reach larger evacuation routes.

If one of these segments becomes obstructed or congested, evacuation times could increase significantly.

### 3. Dependence on Regional Mountain Corridors
...
### 4. High Sensitivity to Road Obstructions
